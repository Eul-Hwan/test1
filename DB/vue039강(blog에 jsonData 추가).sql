...
-- 테이블 데이터 test.blogs:~10 rows (대략적) 내보내기
...
INSERT INTO `blogs` (`id`, `title`, `post`, `jsonData`, `post_excerpt`, `slug`, `user_id`, `featuredImage`, `metaDescription`, `views`, `created_at`, `updated_at`) VALUES
	(12, NULL, '<p class="blog_post_text">\n                        My awesome blog\n                    </p><h2 class="blog_post_h2">후후 하하ㅋㅋ</h2>', '{"time":1609060381654,"blocks":[{"type":"paragraph","data":{"text":"My awesome blog"}},{"type":"header","data":{"text":"후후 하하ㅋㅋ","level":2}}],"version":"2.19.1"}', 'My awesome blog', '', 1, NULL, 'this ls awesome description for seo', 0, '2020-12-27 18:13:02', '2020-12-27 18:13:02'),
	(13, NULL, '<p class="blog_post_text">\n                        블라 블라\n                    </p><h2 class="blog_post_h2">그래그래 아녀 아녀 ㅋㅋ</h2>', '{"time":1609060570648,"blocks":[{"type":"paragraph","data":{"text":"블라 블라"}},{"type":"header","data":{"text":"그래그래 아녀 아녀 ㅋㅋ","level":2}}],"version":"2.19.1"}', '블라 블라', '-2', 1, NULL, '이것은 대단하다잉~~!', 0, '2020-12-27 18:16:11', '2020-12-27 18:16:11'),
	(14, NULL, '<p class="blog_post_text">\n                        yes <mark class="cdx-marker">nice</mark>\n                    </p>', '{"time":1609060811429,"blocks":[{"type":"paragraph","data":{"text":"yes <mark class=\\"cdx-marker\\">nice</mark>"}}],"version":"2.19.1"}', 'wow', 'awesome-its-working', 1, NULL, 'yes...', 0, '2020-12-27 18:20:11', '2020-12-27 18:20:11');
