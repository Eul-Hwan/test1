...
CREATE TABLE IF NOT EXISTS `blogcategories` (
  ...
  CONSTRAINT `FK_blogcategories_blogs` FOREIGN KEY (`blog_id`) REFERENCES `blogs` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 테이블 데이터 test.blogcategories:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 test.blogs:~1 rows (대략적) 내보내기
...
INSERT INTO `blogs` (`id`, `title`, `post`, `jsonData`, `post_excerpt`, `slug`, `user_id`, `featuredImage`, `metaDescription`, `views`, `created_at`, `updated_at`) VALUES
	(28, '졸리냐? 나도 졸리다.23', '<p class="blog_post_text">\n                        자고 싶으다.~~!23\n                    </p><p class="blog_post_text">\n                        아이유 노래 잘함\n                    </p><p class="blog_post_text">\n                        김고은 연기 잘함\n                    </p>', '{"time":1609566167206,"blocks":[{"type":"paragraph","data":{"text":"자고 싶으다.~~!23"}},{"type":"paragraph","data":{"text":"아이유 노래 잘함"}},{"type":"paragraph","data":{"text":"김고은 연기 잘함"}}],"version":"2.19.1"}', '졸려23', '졸리냐? 나도 졸리다.23', 1, NULL, '자장23', 0, '2020-12-31 11:35:41', '2021-01-02 14:42:47');
...
CREATE TABLE IF NOT EXISTS `blogtags` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_blogtags_blogs` (`blog_id`),
  CONSTRAINT `FK_blogtags_blogs` FOREIGN KEY (`blog_id`) REFERENCES `blogs` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 테이블 데이터 test.blogtags:~1 rows (대략적) 내보내기
