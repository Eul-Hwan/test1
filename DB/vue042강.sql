...
-- 테이블 데이터 test.blogcategories:~2 rows (대략적) 내보내기
...
INSERT INTO `blogs` (`id`, `title`, `post`, `jsonData`, `post_excerpt`, `slug`, `user_id`, `featuredImage`, `metaDescription`, `views`, `created_at`, `updated_at`) VALUES
	(22, NULL, '<p class="blog_post_text">\n                        qwe\n                    </p><p class="blog_post_text">\n                        234\n                    </p><p class="blog_post_text">\n                        234\n                    </p><p class="blog_post_text">\n                        234\n                    </p>', '{"time":1609191934769,"blocks":[{"type":"paragraph","data":{"text":"234"}}],"version":"2.19.1"}', '345', '123', 1, NULL, '456', 0, '2020-12-29 06:45:35', '2020-12-29 06:45:35'),
	(23, NULL, '<p class="blog_post_text">\n                        qwe\n                    </p><p class="blog_post_text">\n                        234\n                    </p><p class="blog_post_text">\n                        234\n                    </p><p class="blog_post_text">\n                        234\n                    </p>', '{"time":1609191934769,"blocks":[{"type":"paragraph","data":{"text":"234"}}],"version":"2.19.1"}', '345', '123-2', 1, NULL, '456', 0, '2020-12-29 06:45:35', '2020-12-29 06:45:35');
...
-- 테이블 데이터 test.blogtags:~3 rows (대략적) 내보내기
