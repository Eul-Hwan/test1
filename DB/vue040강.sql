...
INSERT INTO `blogs` (`id`, `title`, `post`, `jsonData`, `post_excerpt`, `slug`, `user_id`, `featuredImage`, `metaDescription`, `views`, `created_at`, `updated_at`) VALUES
	(18, NULL, '<h2 class="blog_post_h2">아이유 최고~!</h2><p class="blog_post_text">\n                        한승연 <mark class="cdx-marker">별루</mark>\n                    </p>', '{"time":1609072017065,"blocks":[{"type":"header","data":{"text":"아이유 최고~!","level":2}},{"type":"paragraph","data":{"text":"한승연 <mark class=\\"cdx-marker\\">별루</mark>"}}],"version":"2.19.1"}', '배고프다', '', 1, NULL, '먹고싶고 자고싶다', 0, '2020-12-27 21:26:57', '2020-12-27 21:26:57');
