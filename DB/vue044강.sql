...
-- 테이블 데이터 test.blogcategories:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 test.blogs:~2 rows (대략적) 내보내기
...
INSERT INTO `blogs` (`id`, `title`, `post`, `jsonData`, `post_excerpt`, `slug`, `user_id`, `featuredImage`, `metaDescription`, `views`, `created_at`, `updated_at`) VALUES
	(28, '졸리냐? 나도 졸리다.', '<p class="blog_post_text">\n                        자고 싶으다.~~!\n                    </p>', '{"time":1609382141286,"blocks":[{"type":"paragraph","data":{"text":"자고 싶으다.~~!"}}],"version":"2.19.1"}', '졸려', '-3', 1, NULL, '자장', 0, '2020-12-31 11:35:41', '2020-12-31 11:35:41');
...
-- 테이블 데이터 test.blogtags:~6 rows (대략적) 내보내기
