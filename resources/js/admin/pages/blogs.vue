					...
					<div class="_overflow _table_div">
						<table class="_table">
							...
							<tr>
								...
								<!-- ITEMS -->
							<tr v-for="(blog, i) in blogs" :key="blogs.id" v-if="blogs.length">
								<td>{{blog.id}}</td>
...
export default {
    ...
    methods : {
        ...
        showDeletingModal(blog, i) {
            // console.log('the index is ', blog.id)
            ...
            const deleteModalObj = {
                ...
                successMsg : 'Bolg has been deleted successfully~~'
            }
    ...
    async created() {
        ...
        // if(this.isReadPermitted) return
